    ...
    const fetchPosts = async () => {
        ...
        try {
            ...
            if (response.ok) {
                ...
                setAllPosts(result.data.reverse()); // Display latest posts first
            } else {
        ...
        <section className="max-w-7xl mx-auto">
            <div>
                ...
                <p className="mt-2 text-[#666e75] text-[14px] max-w-[500px]">
                    Browse through a collection of imaginative and visually stunning images shared by the community.
                </p>
            </div>
